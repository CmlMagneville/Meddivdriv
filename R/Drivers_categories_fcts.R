...
heatmap.categories <- function(list_richness,
  ...
  for (i in c(1:length(list_richness))) {
    ...
    drivers_to_cat_vect <- c(
      ...
      "HerbCons_sum" = "Disturbances",
      "HerbRichn_sum" = "Disturbances",
      "Pr_FInt_2000_2023_mean" = "Disturbances",
      "Pr_FInt_2000_2023_sd" = "Disturbances",
      "Pr_FSurf_2000_2023_pixels" = "Disturbances",

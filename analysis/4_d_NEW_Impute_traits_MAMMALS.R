################################################################################
##
## Script to impute traits based on missForests - for MAMMALS
##
## Camille Magneville
##
## 09/2024
##
## 4_a_NEW_Impute_traits_MAMMALS.R
##
################################################################################
...
funbiogeo_df <- dplyr::rename(sp_tr_MAMMALS, species = Species)
...
# New format:
sp_tr_MAMMALS_df <- sp_tr_MAMMALS %>%
...
species_nm <- rownames(sp_tr_MAMMALS_df)
...
imputed_sp_tr_MAMMALS_df <- impute.missing.traits(sp_tr_NA_df = sp_tr_MAMMALS_df,

################################################################################
##
## Script to compute PD null models for Faith's PD, MPD, MNPD - for BUTTERFLIES
##
## Camille Magneville
##
## 09/2024
##
## 2_a_PD_Null_models_BUTTERFLIES.R
##
################################################################################
...
butterflies_PD_Faith_50km <- compute.PD.per.cell(sp_asb_df = butterflies_occ_df,
                                           phylo = butterflies_phylogeny,
                                           metric_nm = "Faith_index",
                                           grid = "50x50",
                                           taxon = "Butterflies")

# Compute Mean Pairwise Distance (MPD) for 50km cells:
butterflies_PD_MPD_50km <- compute.PD.per.cell(sp_asb_df = butterflies_occ_df,
                                         phylo = butterflies_phylogeny,
                                         metric_nm = "MPD",
                                         grid = "50x50",
                                         taxon = "Butterflies")
...
butterflies_PD_MNTD_50km <- compute.PD.per.cell(sp_asb_df = butterflies_occ_df,
                                          phylo = butterflies_phylogeny,
                                          metric_nm = "MNTD",
                                          grid = "50x50",
                                          taxon = "Butterflies")

saveRDS(butterflies_PD_Faith_50km, here::here("transformed_data",
                                        "div_values_null_models",
                                        "PD_Faith_50km_BUTTERFLIES.rds"))
saveRDS(butterflies_PD_MPD_50km, here::here("transformed_data",
                                      "div_values_null_models",
                                      "PD_MPD_50km_BUTTERFLIES.rds"))
saveRDS(butterflies_PD_MNTD_50km, here::here("transformed_data",
                                       "div_values_null_models",
                                       "PD_MNTD_50km_BUTTERFLIES.rds"))
...
saveRDS(faith_null_models, here::here("transformed_data",
                                      "div_values_null_models",
                                      "PD_Faith_null_models_50km_BUTTERFLIES.rds"))
saveRDS(mpd_null_models, here::here("transformed_data",
                                    "div_values_null_models",
                                    "PD_MPD_null_models_50km_BUTTERFLIES.rds"))
saveRDS(mntd_null_models, here::here("transformed_data",
                                     "div_values_null_models",
                                     "PD_MNTD_null_models_50km_BUTTERFLIES.rds"))
...
butterflies_null_model_faith <- readRDS(here::here("transformed_data",
                                             "div_values_null_models",
                                             "PD_Faith_null_models_50km_BUTTERFLIES.rds"))
butterflies_null_model_mpd <- readRDS(here::here("transformed_data",
                                           "div_values_null_models",
                                           "PD_MPD_null_models_50km_BUTTERFLIES.rds"))
butterflies_null_model_mntd <- readRDS(here::here("transformed_data",
                                            "div_values_null_models",
                                            "PD_MNTD_null_models_50km_BUTTERFLIES.rds"))

# Load the actual values of PD indices:
butterflies_PD_Faith_50km <- readRDS(here::here("transformed_data",
                                          "div_values_null_models",
                                          "PD_Faith_50km_BUTTERFLIES.rds"))
butterflies_PD_MPD_50km <- readRDS(here::here("transformed_data",
                                        "div_values_null_models",
                                        "PD_MPD_50km_BUTTERFLIES.rds"))
butterflies_PD_MNTD_50km <- readRDS(here::here("transformed_data",
                                         "div_values_null_models",
                                         "PD_MNTD_50km_BUTTERFLIES.rds"))


# Compute SES for Faith PD:
butterflies_ses_faith_df <- compute.null.model.metrics(null_model_df = butterflies_null_model_faith,
                                                 null_metric_to_compute = c("ses"),
                                                 ind_values_df = butterflies_PD_Faith_50km)
saveRDS(butterflies_ses_faith_df, here::here("transformed_data",
                                       "div_values_null_models",
                                       "PD_Faith_null_models_metrics_50km_BUTTERFLIES.rds"))


# Compute SES ratios for MPD:
butterflies_ses_mpd_df <- compute.null.model.metrics(null_model_df = butterflies_null_model_mpd,
                                               null_metric_to_compute = c("ses"),
                                               ind_values_df = butterflies_PD_MPD_50km)
saveRDS(butterflies_ses_mpd_df, here::here("transformed_data",
                                     "div_values_null_models",
                                     "PD_MPD_null_models_metrics_50km_BUTTERFLIES.rds"))


# Compute SES ratios for MNTD:
butterflies_ses_mntd_df <- compute.null.model.metrics(null_model_df = butterflies_null_model_mntd,
                                                null_metric_to_compute = c("ses"),
                                                ind_values_df = butterflies_PD_MNTD_50km)
saveRDS(butterflies_ses_mntd_df, here::here("transformed_data",
                                      "div_values_null_models",

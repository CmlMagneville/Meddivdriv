...
reptiles_no_fuzzy_traits_df$ReproPerYear[which(reptiles_no_fuzzy_traits_df$Species == "Tarentla mauritanica")] <- 2
...
# Save the traits:
saveRDS(reptiles_no_fuzzy_traits_df, file = here::here("transformed_data",
...
funbiogeo_df <- dplyr::rename(reptiles_no_fuzzy_traits_df, species = Species)

################################################################################
##
## Script to compute PD null models for Faith's PD, MPD, MNPD - for REPTILES
##
## Camille Magneville
##
## 03/04/2024
##
## 2_a_PD_Null_models_REPTILES.R
##
################################################################################
...
reptiles_PD_Faith_50km <- compute.PD.per.cell(sp_asb_df = reptiles_occ_df,
                                           phylo = reptiles_phylogeny,
                                           metric_nm = "Faith_index",
                                           grid = "50x50",
                                           taxon = "Reptiles")

# Compute Mean Pairwise Distance (MPD) for 50km cells:
reptiles_PD_MPD_50km <- compute.PD.per.cell(sp_asb_df = reptiles_occ_df,
                                         phylo = reptiles_phylogeny,
                                         metric_nm = "MPD",
                                         grid = "50x50",
                                         taxon = "Reptiles")
...
reptiles_PD_MNTD_50km <- compute.PD.per.cell(sp_asb_df = reptiles_occ_df,
                                          phylo = reptiles_phylogeny,
                                          metric_nm = "MNTD",
                                          grid = "50x50",
                                          taxon = "Reptiles")
...
PD_null_asb_list <- compute.null.model.PD(phylo_tree = reptiles_phylogeny,
                                          sp_asb_df = reptiles_occ_df,
                                          nb_asb_rep = 500)
...
reptiles_null_model_faith <- readRDS(here::here("transformed_data",
                                                "div_values_null_models",
                                             "PD_Faith_null_models_50km_REPTILES.rds"))
reptiles_null_model_mpd <- readRDS(here::here("transformed_data",
                                              "div_values_null_models",
                                           "PD_MPD_null_models_50km_REPTILES.rds"))
reptiles_null_model_mntd <- readRDS(here::here("transformed_data",
                                               "div_values_null_models",
                                            "PD_MNTD_null_models_50km_REPTILES.rds"))

# Load the actual values of PD indices:
reptiles_PD_Faith_50km <- readRDS(here::here("transformed_data",
                                             "div_values_null_models",
                                          "PD_Faith_50km_REPTILES.rds"))
reptiles_PD_MPD_50km <- readRDS(here::here("transformed_data",
                                           "div_values_null_models",
                                        "PD_MPD_50km_REPTILES.rds"))
reptiles_PD_MNTD_50km <- readRDS(here::here("transformed_data",
                                            "div_values_null_models",
                                         "PD_MNTD_50km_REPTILES.rds"))


# Compute SES for Faith PD:
reptiles_ses_faith_df <- compute.null.model.metrics(null_model_df = reptiles_null_model_faith,
...
reptiles_ses_mpd_df <- compute.null.model.metrics(null_model_df = reptiles_null_model_mpd,
                                               null_metric_to_compute = c("ses"),
...
reptiles_ses_mntd_df <- compute.null.model.metrics(null_model_df = reptiles_null_model_mntd,
                                                null_metric_to_compute = c("ses"),

...
butterflies_rf <- readRDS(here::here("transformed_data", "rf_butterflies_PD_Faith_50.rds"))
mammals_rf <- readRDS(here::here("transformed_data", "rf_mammals_PD_Faith_50.rds"))
...
reptiles_rf <- readRDS(here::here("transformed_data", "rf_reptiles_PD_MPD_50.rds"))
trees_rf <- readRDS(here::here("transformed_data", "rf_trees_PD_MPD_50.rds"))
mammals_rf <- readRDS(here::here("transformed_data", "rf_mammals_PD_MPD_50.rds"))
butterflies_rf <- readRDS(here::here("transformed_data", "rf_butterflies_PD_MPD_50.rds"))
...
mammals_rf <- readRDS(here::here("transformed_data", "rf_mammals_PD_MNTD_50.rds"))
butterflies_rf <- readRDS(here::here("transformed_data", "rf_butterflies_PD_MNTD_50.rds"))
